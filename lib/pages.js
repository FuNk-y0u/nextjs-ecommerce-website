...
export const getEndpoint = (endpoint) => {
  switch (endpoint) {
    ...
    case endPoints.getBestSeller:
      return `${process.env.NEXT_PUBLIC_SV_IP}/api/items/getbestseller`;
    case endPoints.getForYou:
      return `${process.env.NEXT_PUBLIC_SV_IP}/api/items/foryou`;
    case endPoints.getItemwd:
      return `${process.env.NEXT_PUBLIC_SV_IP}/api/items/getitemwd`;
  }
};
